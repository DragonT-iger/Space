...
public class SmsService {
	...
	public SmsResponseDTO sendSms(String recipientHP, String content) throws JsonProcessingException, RestClientException, URISyntaxException, InvalidKeyException, NoSuchAlgorithmException, UnsupportedEncodingException {
		//현재 시간
		Long time = System.currentTimeMillis();  
		List<MessageDTO> messages = new ArrayList<>();
		messages.add(new MessageDTO(recipientHP, content));
		...
		SmsRequestDTO request = new SmsRequestDTO("SMS", "COMM", "82", phone, "MangoLtd", messages);
		/*
