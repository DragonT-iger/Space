...
<table class="table1">
	...
	<tbody class="body">
		...
		<tr class="body_two">
			...
			<td><input class="reason" type="radio" name="r_code" value="1" id="r1"><label for="1">단순변심</label></td>
		</tr>

		<tr>
			<td><input class="reason" type="radio" name="r_code" value="2" id="r2"><label for="2">예약정보 변경(일정,연락처)/중복예약</label></td>
		</tr>
		<tr>
			<td><input class="reason" type="radio" name="r_code" value="3" id="r3"><label for="3">호스트 요청에 따른 이용불가</label></td>
		</tr>
		<tr>
			<td><input class="reason" type="radio" name="r_code" value="4" id="r4"><label for="5">이용조건 불만</label></td>
		</tr>
		<tr>
			<td><input class="reason" type="radio" name="r_code" value="5" id="r5"><label for="5">기타</label></td>
		</tr>
	...
	<div class="btn1">
	<button class="btn btn-danger btn">예약취소</button>
	<button type="button" class="btn btn-primary btn" onclick="history.back()">Back</button>
	</div>
</form>       
</div>
