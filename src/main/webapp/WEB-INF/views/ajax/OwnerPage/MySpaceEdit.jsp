	...
	<form name="sf" id="sf" role="form" action="spaceInsert" method="POST"
		...
		<table class="table">
			<tr>
				...
				<td style="width: 80%"><input type="text" name="sname"id="sname" value="<c:out value="${Space_info.sname}"/>" class="form-control"></td>
			</tr>
			<tr>
				<td style="width: 20%"><b>컨셉카테고리</b></td>
				<td style="width: 80%">
					<input class="form-control" list="hashlist" name="h_code" id="h_code" value="<c:out value="${Space_info.h_code}"/>">
			...
			<tr>
				...
				<td style="width:80%">
					<div class="row">
						<div class="col">
					      	<input type="number" name="bcost" id="bcost" class="form-control" placeholder="기본비용" value="<c:out value="${Space_info.bcost}"/>">
					    </div>
					    <div class="col">
							<input type="number" name="ecost" id="ecost" class="form-control" placeholder="인원추가금" value="<c:out value="${Space_info.ecost}"/>">
					    </div>
				    </div>
				</td>
			</tr>
			<tr>
				...
				<td style="width:80%">
					<div class="row">
						<div class="col">
					      	<input type="number" name="minn" id="minn" class="form-control" placeholder="추가금 인원설정" value="<c:out value="${Space_info.minn}"/>">
					    </div>
					    <div class="col">
							<input type="number" name="maxn" id="maxn" class="form-control" placeholder="최대 인원수" value="<c:out value="${Space_info.maxn}"/>">
					    </div>
				    </div>
				</td>
			</tr>
			...
			<tr>
				...
				<td width="80%" class="m2"><input type="text" name="post" id="post" placeholder="Post" maxlength="5" value="<c:out value="${Space_info.spost}"/>">
					<button type="button" class="btn btn-success" onclick="postfind()">우편번호 찾기</button></td>
			</tr>
			<tr>
				<td width="20%"><b>주소</b></td>
				<td width="80%">
					<input type="text" class="form-control" name="addr1" id="addr1" placeholder="Address" value="<c:out value="${Space_info.addr1}"/>"><br> 
					<input type="text" class="form-control" name="addr2" id="addr2" placeholder="상세주소" value="<c:out value="${Space_info.addr2}"/>"></td>
			</tr>
			<tr>
