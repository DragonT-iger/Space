	    ...
	    <!-- 업데이트 idx 값 저장-->
	  	<table class="table table-borderless mt-5 mb-5" id="edit_table">
	  		<tr>
	  			<td><h5>회원아이디</h5></td>
	  			<td>
                    <input type="text" class="form-control border-primary py-3 ps-4" id="userid" name="userid" value="${loginUser.userid }" readonly="readonly">
	  			</td>
		   	</tr>
	  		<tr>
	  			<td><h5>닉네임</h5></td>
	  			<td>
                    <input type="text" class="form-control border-primary py-3 ps-4" id="nickname" name="nickname" value="${loginUser.nickname }" placeholder="수정할 닉네임">
	  			</td>
		   	</tr>
		   	<tr>
	  			<td><h5>현재 비밀번호</h5></td>
	  			<td>
	  				<input type="password" class="form-control border-primary py-3 ps-4" id="mpwdcheck" name="mpwdcheck"  value="" placeholder="현재 비밀번호">
	  			</td>
		   	</tr>
		   	<tr>
	  			<td><h5>새 비밀번호</h5></td>
	  			<td>
	  				<input type="password" class="form-control border-primary py-3 ps-4" id="mpwd1" name="mpwd1"  value="" placeholder="수정할 비밀번호">
	  			</td>
		   	</tr>
		   	<tr>
	  			<td><h5>새 비밀번호확인</h5></td>
	  			<td>
	  				<input type="password" class="form-control border-primary py-3 ps-4" id="mpwd" name="mpwd"  value="" placeholder="수정할 비밀번호 확인">
	  			</td>
		   	</tr>
		   	<tr>
	  			<td><h5>연락처</h5></td>
	  			<td>
	   			<input type="text" class="form-control border-primary py-3 ps-2" id="hp" name="hp" value="${loginUser.hp }" placeholder="ex)010or011 숫자 7~8자리" maxlength="11">
		   	...
		   	<tr>
	  			<td><h5>계좌정보</h5></td>
	  			<td>
	  				<input type="text" class="form-control border-primary py-3 ps-4" id="account" name="account"  value="${loginUser.account }" placeholder="수정할 계좌번호">
	  			</td>
		   	</tr>
		   	<!-- <tr>
	  			<td>회원상태</td>
