	...
	<div class="container-xxl py-5">
		<div class="container">
			<div class="text-center wow fadeInUp" data-wow-delay="0.1s">
				<h5
					class="section-title ff-secondary text-center text-primary fw-normal">Welcome
					to Space</h5>
				...
				<div class="row g-4">
					<div class="col-12">
						<div class="row gy-4">
							<div class="col-10">
								...
								<div class="col-md-6">
									<input type="text" class="form-control" id="userid"
										name="userid" placeholder="Your Id" required> <label
										for="saveId"> <input type="checkbox" name="saveId"
										id="saveId">Save ID
									</label>
								</div>
							</div>
							<div class="col-md-10">
								<h5
									class="section-title ff-secondary fw-normal text-start text-primary">PASSWORD</h5>
								<div class="col-md-6">
									<input type="password" name="mpwd" class="form-control"
										id="mpwd" required placeholder="Your Password">
								</div>
							</div>
						</div>
					</div>
